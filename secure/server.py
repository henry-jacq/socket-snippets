...
class SecureServer:
    def __init__(self, host='0.0.0.0', port=5000):
        ...
        self.port = port
        self.clients = {}
        self.agent_tokens = {"agent-123": "valid"}  # Example agent tokens
    ...
    def handle_client(self, client_socket, client_address):
        try:
            ...
            # Step 2: Receive agent token
            agent_token = client_socket.recv(1024).decode()
            if not self.authenticate_agent(agent_token):
            ...
            while True:
                ...
                client_socket.sendall(self.encrypt_message(session_key, response))
    ...
    def authenticate_agent(self, token):
        return self.agent_tokens.get(token) == "valid"
